...
#
    def __init__(self, input_nf):
        ...
        self.fc01 = torch.nn.Sequential(
            torch.nn.Linear(in_features=self.input_nf*self.input_nf, out_features=108, bias=True),
            torch.nn.ReLU()
        )
        ...
        self.fc06 = torch.nn.Sequential(
            torch.nn.Linear(in_features=108, out_features=self.input_nf*self.input_nf, bias=True),
            torch.nn.Sigmoid()
        )
#
### Encode
